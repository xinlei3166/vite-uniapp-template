...
export const getUserMenu = (config?: Config): Promise<any> => {
  // return requests.get('/mock/user/menu', config)
  return mock.getUserMenu()
}

// 权限列表-扁平化
export const getPermissions = (config?: Config): Promise<any> => {
  // return requests.get('/mock/user/permissions', config)
  return mock.getPermissions()
}

// 用户当前菜单列表
export const getUserinfo = (config?: Config): Promise<any> => {
  // return requests.get('/mock/user/info', config)
  return mock.getUserinfo()
}

// 普通用户登录
export const login = (data?: Request) => {
  // return requests.post('/mock/user/login', data)
  return mock.login()
}

// 退出登录
export const logout = () => {
  // return requests.post('/mock/user/logout')
  return mock.logout()
}
